...
<html lang="en">
	...
	<body>
		...
		<?php
			...
			if($situacao_conclusao == NULL){ // Checando que o usuário já solicitou um histórico esse período
				// Caso ele não tenha solicitado ainda, o sistema avisa que é o primeiro, e que não é necessário pagar, e chama o script salvarPedido1.php
                            echo "<form action=\"salvarPedido1.php\" method=\"post\">
                                    <p>Essa é a requisição da primeira via do certificado de conclusão de curso, que será grátis. Clique em continue para prosseguir.</p>
				...
				o código do comprovante e salva a imagem do mesmo*/ 
                            echo "<form action=\"salvarPedido2.php\" method=\"post\" enctype=\"multipart/form-data\">
                                    <p>Você já solicitou o certificado de conclusão de curso, para tirar a segunda via é necessário efetuar o pagamento na conta da UPE. Anexe uma imagem do seu comprovante e digite o ID do comprovante: <br>
