...
<html lang="en">
	...
	<body>
		...
		<?php
			...
			$sql= "INSERT INTO `certificado_conclusao`(`nome`, `cpf`) VALUES "; // Cadastrando o histórico no BD
			$sql= $sql."('$nome','$cpf')";
			...
			*/
			if($situacao_conclusao == NULL){
				
				$sql = "UPDATE profile SET emissao_diploma = '1' where user_id = ".$user_id;
				$resultado = mysqli_query($conexao,$sql);
