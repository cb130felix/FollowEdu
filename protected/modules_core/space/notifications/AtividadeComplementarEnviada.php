...
class SpaceApprovalRequestAcceptedNotification extends Notification {
    ...
    public $webView = "space.views.notifications.AtividadeComplementarEnviada";
    public $mailView = "application.modules_core.space.views.notifications.AtividadeComplementarEnviada_mail";

    public static function fire($approverUserId, $requestor, $workspace) {
        // Send Notification to owner
        $notification = new Notification();
        $notification->class = "AtividadeComplementarEnviada";
